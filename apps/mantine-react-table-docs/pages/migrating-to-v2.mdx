...
Mantine React Table V2 is a major upgrade that aligns with Mantine V8 and introduces improved styling, modular architecture, and better developer ergonomics. While the core API remains familiar, there are several breaking changes and setup updates to be aware of.

### New Feature Highlights

1. Compatible with Mantine V8.3.9+ with improved styling and performance  
...
#### 1. Upgrade Mantine to V8

Before upgrading Mantine React Table, you need to upgrade Mantine to V8.3.9+. Follow the [Mantine installation guide](https://mantine.dev/getting-started/) for framework-specific instructions.
...
<InstallCommand packagesString="@mantine/core@^8.3.9 @mantine/hooks@^8.3.9 @mantine/dates@^8.3.9 @tabler/icons-react clsx dayjs" />
...
- Mantine v6 and v7 are no longer supported. MRT now requires Mantine v8.3.9+ for full compatibility.
